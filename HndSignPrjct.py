...
class hand_sign:
    ...
    def search(self):
        ...
        elif self.spec=="Запретная" and self.first=="змея" and self.second=="свинья" and self.third=="овца" and self.fourth=="кролик" and self.fifth=="собака" and self.sixth=="крыса" and self.seventh=="птица" and self.eight=="лошадь" and self.ninth=="змея":
